...
import com.podcazity.podcastalert.service.CreateXspf;
import com.podcazity.podcastalert.service.TrackService;

@Service("createXspf")
public class CreateXspfImpl implements CreateXspf{
	...
	public List<Track> getLastetTracks() {
		return trackService
				.listAllByPage(new PageRequest(0, 100, Direction.DESC, "trackDate"))
				.getContent();
	}
